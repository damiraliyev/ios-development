...
protocol OnboardingContainerViewControlledDelegate: AnyObject{
...
class OnboardingContainerViewController: UIViewController {
    ...
    weak var delegate: OnboardingContainerViewControlledDelegate?
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Move your money around the world quickly and securily.")
